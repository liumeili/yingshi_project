<template>
  <div class="index"> 
      ...
      <div class="index-topSearch">
          <van-search placeholder="请输入搜索关键词" v-model="searchVue" @search="onSearch"/>
          <img src="../assets/img/tip.png" class="topSearch-tipImg">
          <img src="../assets/img/time.png" class="topSearch-timepImg">
      </div>
      <!-- 顶部导航 -->
      ...
      <div class="content_BOX">
          ...
          <ul class="pd-ul" v-if="pingdaoId!=0">
             <li v-for="(item,index) in pingdaoList" :key="index" v-if="index<7">{{item.tag}}</li>
